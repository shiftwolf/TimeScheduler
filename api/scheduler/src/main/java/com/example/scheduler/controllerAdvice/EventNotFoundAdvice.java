 ...
 * @author Max
 * @version 1.0
 * Controller Advice that holds the Handler for the {@link com.example.scheduler.exceptions.EventNotFoundException}
 */
@ControllerAdvice
public class EventNotFoundAdvice {
     ...
     * @param ex EventNotFoundException the Handler listens to
